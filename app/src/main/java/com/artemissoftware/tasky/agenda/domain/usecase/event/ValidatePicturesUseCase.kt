...
class ValidatePicturesUseCase @Inject constructor(
    ...
    suspend operator fun invoke(pictures: List<Picture>): PictureValidation {
        ...
        return PictureValidation(numberOfRejectedPictures = rejectedPictures, validPictures = list)
    }
}
