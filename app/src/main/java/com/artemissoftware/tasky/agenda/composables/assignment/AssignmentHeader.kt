...
private fun AssignmentHeaderPreview() {
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
        AssignmentHeader(assignment = Assignment.Reminder(), title = "First title")
        AssignmentHeader(assignment = Assignment.Task(), isEditing = true, title = "Second title")
        AssignmentHeader(assignment = Assignment.Event(), isEditing = true, title = "Third title")
    }
